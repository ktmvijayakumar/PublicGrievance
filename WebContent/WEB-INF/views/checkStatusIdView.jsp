...
<div class="image container">
	<div class="row no-gutters">
		...
		<div class="col-lg-6" >
			<div class="checkComplaintStatus">
				<center>
					 <h1>Check Complaint Status</h1>
					 <p style="color: red;">${errorString}</p>
					 <form method="POST" action="${pageContext.request.contextPath}/checkStatusId"> 
				        	  <input type="text" name="complaintId" placeholder="Complaint Id"/> <br>
