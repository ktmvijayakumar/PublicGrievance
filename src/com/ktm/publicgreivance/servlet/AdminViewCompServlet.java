...
@WebServlet(urlPatterns = { "/adminViewCompList" })
public class AdminViewCompServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
 
    public AdminViewCompServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            list = DBUtils.queryAdminComplaint(conn);
        ...
        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/adminViewCompView.jsp");
        dispatcher.forward(request, response);
         }
