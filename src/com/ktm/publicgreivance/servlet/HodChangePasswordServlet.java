...
@WebServlet(urlPatterns={"/hodchangePassword"})
public class HodChangePasswordServlet extends HttpServlet {
	 private static final long serialVersionUID = 1L;
	 
	public HodChangePasswordServlet(){
		super();
	}
    ...
    protected void doGet(HttpServletRequest request,HttpServletResponse response){
    	try{
    	    ...
    	    {		
    			...
    			RequestDispatcher dispatcher 
            	 	= this.getServletContext().getRequestDispatcher("/WEB-INF/views/hodchangePasswordView.jsp");
               	...
               	// System.out.println("login");
                	HttpSession session = request.getSession();
         	        ...
         	        // Check User has logged on
               	 	...
               	 	String user=loginedUser.getHodname();
               	 	System.out.println(user);
               	 	DBUtils.HodChangePassword(conn, user, password);
               	 		request.setAttribute("successMessage","Password changed...");
                        request.setAttribute("user", loginedUser);
    	            	RequestDispatcher rd1 = request.getRequestDispatcher("/WEB-INF/views/hodView.jsp");
